  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.username}>Dini Safitri</Text>
        <Text style={styles.usernim}>120140165</Text>
      </View>
      <View style={styles.infoContainer}>
        <View style={styles.infoItem}>
          <Text style={styles.infoLabel}>Nama Lengkap</Text>
          <Text style={styles.infoValue}>Dini Safitri</Text>
        </View>
        <View style={styles.infoItem}>
          <Text style={styles.infoLabel}>NIM</Text>
          <Text style={styles.infoValue}>120140165</Text>
        </View>
        <View>
          <View style={styles.infoItem}>
